/**
 * V0.6 spatial bucket aggregation — layer factors applied before intensity×polarity.
 */
...
export interface V06LayerMassBreakdown {
...
export interface V06BucketAggregateResult {
  ...
  layerMass: V06LayerMassBreakdown;
}
...
export function aggregateV06Buckets(
  deduped: DedupedSpatialPaths,
  knowledge: AnnualAxesKnowledgeV06NamPhai,
  options?: { signedLayerFactorsOverride?: AnnualSignedLayerFactorsV06 },
): V06BucketAggregateResult {
