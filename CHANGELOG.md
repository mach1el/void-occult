...
- **Tử Vi**: Đổi mặc định công cụ xem hạn trên giao diện sang Tiểu hạn (thay vì Lưu niên).
...
- **Tử Vi**: Desktop — lá số gọn fit view (trần ~1120px, sized theo chiều cao viewport), rộng hơn bản nhỏ cũ nhưng không phình full page; SVG giữ `width`/`height` attribute để không collapse mất lưới 12 cung.
