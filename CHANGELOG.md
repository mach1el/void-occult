...
### Thêm Mới (Added)
- **Tử Vi**: Radar vận hạn 6 trục theo năm xem (Sức khỏe · Gia đạo · Tài lộc · Công việc · Giao hữu · Tình duyên) đặt cạnh radar Khí vận 12 cung — engine heuristic từ điểm nền cung + sao Lưu + guardrails, breakdown minh bạch.
