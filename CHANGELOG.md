...
### Sửa Lỗi (Fixed)
- **Tử Vi**: Phóng to lá số desktop theo chiều cao viewport (không còn kẹt trần 1040px cứng trên màn QHD), cột lá số rộng hơn chat; SVG giữ `width`/`height` attribute để không collapse mất lưới 12 cung.
